...
export default function CreatePack() {
  ...
  return (
    <>
      <Head>
        <title key="title">Card Pack Editor - Flippy - Flashcard App</title>
      </Head>
      <Navbar />
      {isMobile ? (
          ...
          <PlaceholderColumn
            options={{
              ...
              message: {
                ...
                description: "Card Pack Editing is not avaiable in mobile yet!",
              },
            }}
          />
        </div>
    ...
    <div className="placeholder-wrapper flex justify-center">
      <PlaceholderColumn
        options={{
          ...
          message: {
            title: "Not Allowed",
            description: "You need an account to create or edit card packs!",
          },
          action: {
          ...
          <PlaceholderColumn
            options={{
              ...
              message: {
                ...
                description: (
                  <>
                    Card Pack might be deleted. Otherwise, Try refreshing! If it
                    keeps persisting please reach out to us on{" "}
                    <Link
