...
export default function MatchPostGameDetails() {
  const [gameSettings, setGameSettings] = useRecoilState(gameSettingsSelector);
    ...
    <div id="match-post-game-screen">
      <div className="top">
        <div className="details">
          ...
          <div className="time">
            <div className="text-blue-600 font-bold mx-2 my-0">My Time</div>
            <div className="break-words">{Math.round(time / 10) / 100} s</div>
          </div>
        ...
        <div className="leaderboard">
          <div className="text-blue-600 font-bold mx-2 my-0">Leaderboard</div>
