...
export default function AddBetweenTrigger({ index }) {
    ...
    return (
        <div className="add-between-trigger relative z-[1]">
            <div
                className="inner absolute bottom-0 w-[1300px] h-[96px]"
                onMouseEnter={() => {
            ...
            {current === idRef.current && (
                <motion.div
                    ...
                    layoutDependency={1}
                    className="button group/addTrigger pointer flex items-center absolute bottom-5 left-[890px] "
                    onClick={() => {
                        // add item at index
                ...
                >
                    ...
                    >
                        <path
                            ...
                            className="transition-colors fill-blue-300 group-hover/addTrigger:fill-blue-400"
                        />
                    </svg>

                    <div className="box-border flex items-center gap-3 bg-blue-300 group-hover/addTrigger:bg-blue-400 right w-[192px] px-3 py-1 rounded-xl transition-colors">
                        <svg
                            style={{
                                width: "32",
                                height: "32",
                        ...
                        <div className="mx-2 my-0 font-bold text-blue-800">
                            Add Between
                        </div>
                    </div>
                </motion.div>
