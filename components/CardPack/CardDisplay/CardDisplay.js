  ...
  return (
    <>
      <div className="controls">
        <div className="left">
          {/* <div className="w-5 h-5 rounded-full flex justify-center items-center transition-colors cursor-pointer hover:bg-blue-300 active:bg-blue-300">{number_svg}</div> */}
          {/* <div className="w-5 h-5 rounded-full flex justify-center items-center transition-colors cursor-pointer hover:bg-blue-300 active:bg-blue-300">{atoz_svg}</div> */}
          <div
            className="w-5 h-5 rounded-full flex justify-center items-center transition-colors cursor-pointer hover:bg-blue-300 active:bg-blue-300"
            onClick={() => shuffle()}
          >
            <MyHoverTooltip
