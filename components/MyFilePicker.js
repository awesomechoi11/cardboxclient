...
export default function MyFilePicker({
  ...
  return (
    <div className="file-picker-wrapper mb-[16rem]">
      ...
      <div
        ...
        className="cursor-pointer rounded-[16rem] py-[24rem] px-[30rem] border-2 border-dashed border-brown-600 "
      >
        {imgSrc ? (
          <div className="max-w-full h-[152rem] relative ">
            <Image
...
export function MyFilePickerCreatePackField({
  ...
  let imgSrc = normalizeImageSrc(file);
  return (
    <div className={clsx(className, "file-picker-wrapper-create-pack-field")}>
      <div
        onClick={() =>
          openModal({
            mode: "picker",
