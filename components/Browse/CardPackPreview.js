  ...
  return (
    <div className="preview">
      <AnimatePresence>
              ...
              <PlaceholderColumn
                options={{
                  ...
                  message: {
                    ...
                    description: "or click below to make your own",
                  },
                  action: {
        ...
        {isLoading && (
          <motion.div key="loading" className="inner" {...previewAnim}>
            <div className="placeholder-wrapper flex justify-center">
  ...
  return (
    <div className="field">
      ...
      <div className="content-wrapper">
        <div className="label text-blue-600 font-bold mx-2 my-0">{label}</div>
        <div
...
function Header({ data }) {
  const { likes = 0, shares = 0, duplicates = 0, title, authorDetails } = data;
  const {
    selectedState: [selected],
  } = useContext(BrowseContext);
    ...
    <div className="details">
      ...
      <div className="text-blue-600 font-bold mx-2 my-0 middle">
        {[
          ...
          selected.collection !== "cardpackDrafts" && millify(views) + " Views",
        ]
          .filter(Boolean)
          .join(" · ")}
      </div>
